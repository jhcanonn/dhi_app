...
export { default as MenuExamsPrescription } from './MenuExamsPrescription'
export { default as ExtraDataDetail } from './ExtraDataDetail'
export { default as PaymentWayItems } from './PaymentWayItems'
export { Th, Tr, default as ExtraData } from './ExtraData'
